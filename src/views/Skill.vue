      ...
      <div class="frontend">
        ...
        <div class="skill-section">
          ...
          <SkillBlock icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg"
            name="BootStrap" :level=4 text="基本プロパティを始め、フォームの作成、row/colを活用したGridレイアウトの構築、内部のSassのカスタマイズ等、幅広い知識を持っています。" />
      ...
      <div class="tool-others">
        ...
        <div class="oowaku">
          <div class="skill-section">
            ...
            <SkillBlock icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" name="Git"
              :level=4 />

            <SkillBlock icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" name="Github"
              :level=4 text="add, commit, push, pull等の基礎的なコマンドやbranch, checkout等のブランチ管理、mergeする際のコンフリクト解決もできます。" />
